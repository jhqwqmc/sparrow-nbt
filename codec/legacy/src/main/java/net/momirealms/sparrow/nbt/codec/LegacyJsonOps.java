...
public class LegacyJsonOps implements DynamicOps<JsonElement> {
    public static final LegacyJsonOps INSTANCE = new LegacyJsonOps(false);
    public static final LegacyJsonOps COMPRESSED = new LegacyJsonOps(true);

    private final boolean compressed;

    protected LegacyJsonOps(final boolean compressed) {
